...
// Update existing
data.forEach(receta => {
  const isVegan = !receta.ingredientes.some(i => i.smae_id && (i.smae_id.includes('carnes') || i.smae_id.includes('lacteos')));
  ...
  if (receta.ingredientes.some(i => i.nombre.toLowerCase().includes('limón') || i.nombre.toLowerCase().includes('naranja') || i.nombre.toLowerCase().includes('fresa'))) {
